...
type tag = string
(* a string to tell between and local environments and blocks *)
...
(* a tag denoting stack entries generated by blocks *)
...
val add_topenv : tag -> env_stack -> unit
(* pushes a tagged copy of the top environment *)

val pop_blocks : env_stack -> stackval
(* pops all stack entries related to blocks, plus the first local environment *)
